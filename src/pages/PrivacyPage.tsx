...
import { DEFAULT_PRIVACY_BODY, DEFAULT_PRIVACY_TITLE, DEFAULT_LEGAL_UPDATED } from '@/lib/cmsDefaults';
...
export default function PrivacyPage() {
  ...
  const blocks = parseLegalBody(settings.privacy_body || DEFAULT_PRIVACY_BODY, { company, email });
  ...
  return (
    <div className="relative min-h-screen bg-black text-white">
      ...
      <main className="relative z-[1] max-w-3xl mx-auto px-4 sm:px-6 pt-24 pb-16">
        ...
        <h1 className="text-2xl sm:text-3xl font-bold mb-2">{settings.privacy_title || DEFAULT_PRIVACY_TITLE}</h1>
        <p className="text-sm text-gray-500 mb-8">Last updated: {settings.privacy_updated || DEFAULT_LEGAL_UPDATED}</p>
